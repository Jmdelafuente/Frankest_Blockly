var MSG = {
  ...
  remixTooltip: "Comparte tus bloques para remixarlos.",
  ...
  catMath: "Matemáticas",
  catText: "Texto",
  catMovement: "Movimiento",
  catStart: "Inicio",
  catVision: "Visión",
  catInteraction: "Interacción",
  catLists: "Listas",
  catColour: "Color",
  catVariables: "Variables",
  catFunctions: "Funciones",
  catFrankest: "Frankestito",
  listVariable: "lista",
  textVariable: "texto",
  ...
  xmlError: "No se pudo cargar el archivo guardado.  ¿Quizá fue creado con otra versión de FrankLab?",
